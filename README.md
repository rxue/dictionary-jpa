...
*dictionary-jpa* can generate a simple dictionary database schema or be used as a third-party library for getting expanations from the existing dictionary database
